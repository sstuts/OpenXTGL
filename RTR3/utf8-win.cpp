...
RTR3DECL(int)  RTStrUtf8ToCurrentCPTag(char **ppszString, const char *pszString, const char *pszTag)
{
    ...
    *ppszString = NULL;
     ...
     */
    int cbResult = WideCharToMultiByte(CP_ACP, 0, (LPCWCH)pwszString, -1, NULL, 0, NULL, NULL);
    if (cbResult > 0)
    {
        /*
        ...
        if (lpString)
        {
             ...
             * Do the translation.
             */
            if (WideCharToMultiByte(CP_ACP, 0, (LPCWCH)pwszString, -1, lpString, cbResult, NULL, NULL) > 0)
            {
                /* ok */
                *ppszString = lpString;
    ...
    *ppszString = NULL;
    ...
    if (cwc > 0)
    {
        ...
        if (pwszString)
        {
             ...
             * Do the translation.
             */
            if (MultiByteToWideChar(CP_ACP, 0, (LPCCH)pszString, -1, (LPWSTR)pwszString, cwc) > 0)
            {
                /*
