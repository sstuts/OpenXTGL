        ...
        CRContext *fromCtx, CRContext *toCtx)
{
    ...
    /* func */
    frontBackDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_FRONT_AND_BACK].func, bitID) ? GL_TRUE : GL_FALSE;
    frontDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_FRONT].func, bitID) ? GL_TRUE : GL_FALSE;
    backDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_BACK].func, bitID) ? GL_TRUE : GL_FALSE;
...
#undef CR_STATE_STENCIL_FUNC_TO_FRONT_BACK_MATCH
    ...
    frontBackDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_FRONT_AND_BACK].op, bitID) ? GL_TRUE : GL_FALSE;
    frontDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_FRONT].op, bitID) ? GL_TRUE : GL_FALSE;
    backDirty = CHECKDIRTY(b->bufferRefs[CRSTATE_STENCIL_BUFFER_REF_ID_BACK].op, bitID) ? GL_TRUE : GL_FALSE;
